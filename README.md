...
* Do you want an output signal when the power tariff is once again within reach after a manual powerdown has been signaled? (currently this can also be seen by comparing how much power Sparegris reports as available for other devices with > 0)
